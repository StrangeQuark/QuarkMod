...
public class GrapplingCrossbowItem extends Item {
    ...
    public ActionResult use(World world, PlayerEntity player, Hand hand) {
        ...
        boolean shouldReturn = !player.isInCreativeMode();
        if (shouldReturn) {
        ...
        hook.configure(GrapplingHookEntity.UseMode.REEL_CROSSBOW, CROSSBOW_RANGE, shouldReturn, hand);
        ...
        if (shouldReturn) {
            player.getInventory().offerOrDrop(projectileStack);
        }
        return ActionResult.FAIL;
    }
