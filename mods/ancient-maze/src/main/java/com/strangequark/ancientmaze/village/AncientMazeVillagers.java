package com.strangequark.ancientmaze.village;
...
import com.strangequark.ancientmaze.enchantment.ModEnchantments;
...
public final class AncientMazeVillagers {
    public static final RegistryKey<VillagerProfession> ANCIENT_KEEPER = RegistryKey.of(
            ...
            AncientMazeMod.id("ancient_keeper")
    );

    private static final float PRICE_MULTIPLIER = 0.0F;
    private static final String KEEPER_TAG = "quarkmod_ancient_maze_keeper";
